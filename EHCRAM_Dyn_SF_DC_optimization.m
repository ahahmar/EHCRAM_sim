% EHCRAM with Dyn. SF/DC optimization
...
L = 50;             % [bytes] the length of the Payload
...
% This step can be replaced by using the random access of EDs (EHCRAM - FHSS)
