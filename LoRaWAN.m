...
input_simulation_duration_seconds=600;
input_draw_playground_map=false;
input_all_nodes_use_same_DR=false;
input_energy_simulate=true;
config_num_iterations=1;
...
input_UL_tx_power_dBm = [14 12 10 8 6 4 2]; 
...
input_SNR_min=[-20, -17.5, -15, -12.5, -10, -7.5]; %[dB] 
%interference matrix for intra-/inter-SF interference
input_interference_matrix=[1 -23 -24 -25 -25 -25; -20 1 -20 -21 -22 -22; -18 -17 1 -17 -18 -19; -15 -14 -13 1 -13 -15; -13 -13 -12 -11 1 -11; -9 -9 -9 -9 -8 1];              
...
input_RX2_DR_notless_UL_DR=true;
...
input_full_duplex_GW=true;%

%ENERGY CONSUMPTION PARAMETERS
input_energy_voltage_V=3.3;
input_energy_current_receive_mA = 38; 
input_energy_current_transmit_per_DR_mA = [38 35.1 32.4 30 27.5 24.7 22.3];
input_energy_current_sleep_mA=0.0016; 
input_energy_current_RXDelay_mA=27; 
input_energy_RX1_empty_duration_per_DR_ms = [262.14 131.07 98.30 49.15 24.58 12.29]; 
input_energy_RX2_empty_duration_per_DR_ms = [33.02 16.64 8.45 4.35 2.30 1.28]; 
        ...
        for config_ctr_loop_EDs=1:1:size(config_loop_EDs,2)
            ...
            for config_ctr_loop_GWs=1:1:size(config_loop_GWs,2)
                ...
                if input_energy_simulate==true
                    ...
                    result_iterations_log_consumption_ED_DL_useful_RX_mJ=zeros(input_num_EDs,config_num_iterations);
                    result_iterations_log_consumption_ED_DL_idle_RX_mJ=zeros(input_num_EDs,config_num_iterations);
