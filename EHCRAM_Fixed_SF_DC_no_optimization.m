% EHCRAM with Fixed SF/DC+ no optimization
...
T = 34200;           % Total simulation time - 60 mins
counter = 1;        % counting variable
T0 = 0;             % initial value of T0
Window = 1;         % size of window observation
nrofdevices = 100;
nrofchannels = 1;   %no. of channels %ceil(freqspan /freqinterval);
nrofpackets = 5;    %[packet] no. of packet from each LoRa ED
BW = 125e3;         %[Hz] Bandwidth - 125khz
start_SF = 6;       % SF values used
end_SF = 6;         % representing for the no of SF values used
